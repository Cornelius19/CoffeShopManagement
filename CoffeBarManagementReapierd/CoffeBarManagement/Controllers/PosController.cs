...
namespace CoffeBarManagement.Controllers
{
    ...
    public class PosController : ControllerBase
    {
        ...
        public async Task<IActionResult> OpenPos(bool status)
        {
            ...
            {
                var orders = await _applicationContext.Orders.Where(q => q.OrderStatus < 4 && 
               q.OrderDate.Year == dateForComarasing.Year &&
               q.OrderDate.Month == dateForComarasing.Month &&
               q.OrderDate.Day == dateForComarasing.Day).ToListAsync();
                if (orders.Count > 0)
                {
    ...
    .Where(q => 
                q.OrderDate.Year == dateForComarasing.Year &&
                q.OrderDate.Month == dateForComarasing.Month &&
                q.OrderDate.Day == dateForComarasing.Day &&
                q.OrderStatus == 4)
    .ToListAsync();
    ...
    .ToListAsync();
            ...
            else
            {
                ...
                if (allEmployees.Count > 0)
                {
                    ...
                    {
                        var takenOrders = await _applicationContext.Orders.Where(q => 
                q.OrderDate.Year == dateForComarasing.Year &&
                q.OrderDate.Month == dateForComarasing.Month &&
                q.OrderDate.Day == dateForComarasing.Day && q.TakenEmployeeId == employee.EmployeeId).ToListAsync();
                        var delieveredOrders = await _applicationContext.Orders.Where(q => 
                q.OrderDate.Year == dateForComarasing.Year &&
                q.OrderDate.Month == dateForComarasing.Month &&
                q.OrderDate.Day == dateForComarasing.Day && q.DeliveredEmployeeId == employee.EmployeeId).ToListAsync();
                ...
                var allSelledProductPerDay = await _applicationContext.OrderProducts.Where(q => 
                q.Order.OrderDate.Year == dateForComarasing.Year &&
                q.Order.OrderDate.Month == dateForComarasing.Month &&
                q.Order.OrderDate.Day == dateForComarasing.Day && q.Order.OrderStatus == 4).ToListAsync();
        ...
        public async Task<PosClosingFiscalReport> GetFiscalReportData()
        {
            ...
            var date = DateTime.Now;
            DateTime dateForComarasing = new DateTime(date.Year, date.Month, date.Day);
            var finishedOrders = await _applicationContext.Orders.Where(q => 
                q.OrderDate.Year == dateForComarasing.Year &&
                q.OrderDate.Month == dateForComarasing.Month &&
                q.OrderDate.Day == dateForComarasing.Day && q.OrderStatus == 4).ToListAsync();
