...
export class AccountService {
    ...
    getUserDetails(userId: number,role:string) {
        return this.http.get(`${environment.appUrl}/api/account/get-user-details/${userId}/${role}`);
    }
    ...
    changePassword(userId: number, model: ChangePassword) {
        return this.http.post(`${environment.appUrl}/api/account/change-password/${userId}`, model);
    }
}
